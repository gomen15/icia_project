...
<body>
    ...
    <form action="/shelter/write" method="post" enctype="multipart/form-data">
    ...
    <input type="date" id="s_date" name="s_date" required><br>
    
    <!-- Date2 -->
    <label for="s_date2">안락사예정일</label>
    <input type="date" id="s_date2" name="s_date2" required><br>
    
    <!-- Age -->
    <label for="s_age">유기애완동물 나이</label>
    <input type="number" id="s_age" name="s_age" required><br>
    ...
    <input type="text" id="s_genetic" name="s_genetic" required><br>
    
    <!-- Weight -->
    <label for="s_weight">애완동물무게(kg단위)</label>
    <input type="text" id="s_weight" name="s_weight" required><br>
